    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <div class="font-medium text-gray-600 me-4 dark:text-gray-300" id="header-current-time"></div>
            ...
            <script>
                function updateHeaderTime() {
                    ...
                    document.getElementById('header-current-time').textContent = timeString;
                }
                updateHeaderTime();
